  ...
  return (
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <header className="border-b border-border flex-shrink-0">
        <div className="px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-foreground">OCTWA DEX</h1>
              <p className="text-xs text-muted">PREVIEW - Intent-based Swap</p>
            </div>
          </div>
              ...
              {connected ? (
                <>
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-card border border-border hover:bg-secondary transition-colors"
                  >
      ...
      {errors.length > 0 && (
        <div className="px-6 pt-4 flex-shrink-0">
          <div className="p-4 bg-destructive/10 border border-destructive/30">
            ...
            {errors.map((error) => (
              <div key={error.id} className="text-xs text-destructive/80 font-mono">
      ...
      <main className="flex-1 flex overflow-hidden">
        {/* Left: Main Content - Centered Vertically */}
        ...
        {sidebar && (
          <div className="w-[420px] border-l border-border overflow-y-auto p-6 flex-shrink-0">
            {sidebar}
          </div>
        )}
      </main>
